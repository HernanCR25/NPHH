    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
            ...
            .authorizeExchange(auth -> auth
                ...
                // GET accesibles para USER y ADMIN
                ...
                // GET de inactivos solo ADMIN
                .pathMatchers(HttpMethod.GET, "/cicloVida/inactivos/**").hasRole("ADMIN")

                // Mutaciones (POST, PUT, DELETE) solo ADMIN
                .pathMatchers(HttpMethod.POST,   "/cicloVida").hasRole("ADMIN")
                .pathMatchers(HttpMethod.PUT,    "/cicloVida/update/**").hasRole("ADMIN")
                .pathMatchers(HttpMethod.PUT,    "/cicloVida/inactivar/**").hasRole("ADMIN")
                .pathMatchers(HttpMethod.PUT,    "/cicloVida/activar/**").hasRole("ADMIN")
                .pathMatchers(HttpMethod.DELETE, "/cicloVida/**").hasRole("ADMIN")
