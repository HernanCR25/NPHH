export interface VaccineApplications {
    ...
    endDate: string | null;     // Fecha de finalización de la aplicación de la vacuna (allow null)
    ...
    times?: string | null;             // Número de veces que se aplica la vacuna (allow null)
}
